...
(although exceedingly ugly!) in *re*\ ``Structured``\ *Text*. Problems are indicated by
...
:download:`This long long long long long long long long long long long long long long long download link should be blue, normal weight text with a leading icon, and should wrap white-spaces <_images/temp.png>`
