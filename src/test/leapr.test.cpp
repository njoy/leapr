...
TEST_CASE( "leapr" ){
  ...
  */
  ...
  std::vector<double> ssm_alpha_50_104_beta_58 { 4.1320631e-19, 4.3767425e-20, 
    4.9157113e-21, 6.1841146e-22, 8.8819050e-23, 1.4063636e-23, 2.3241601e-24, 
    3.8497620e-25, 6.2600002e-26, 5.9811342e-20, 2.3916551e-19, 1.4948148e-18, 
    5.9869396e-18, 2.4052117e-17, 1.5300104e-16, 6.3378448e-16, 1.4817602e-15, 
    2.7434445e-15, 6.7262286e-15, 2.2467595e-14, 5.3479950e-14, 1.4720570e-13, 
    5.4615381e-13, 1.5804905e-12, 8.8637243e-12, 5.1162142e-11, 1.3575290e-10, 
    2.1595391e-10, 2.5824306e-10, 2.5079169e-10, 1.5218712e-10, 1.2193689e-10, 
    2.6988451e-10, 5.2545249e-10, 7.4750365e-10, 8.4378588e-10, 6.1492635e-10, 
    3.4412390e-10, 2.1101840e-10, 7.2150448e-11, 1.7354282e-11, 1.4829980e-12, 
    3.5746962e-13, 1.0050127e-13, 2.0401854e-14, 3.4172822e-15, 5.2474849e-16, 
    7.1887833e-17, 9.4985383e-18, 1.2440973e-18, 1.6003944e-19, 2.0561092e-20, 
    2.6546140e-21, 3.4399382e-22, 4.4694754e-23 };
  for ( size_t i = 0; i < ssm_alpha_0_30_beta_0_30.size(); ++i ){ 
    REQUIRE( ssm_alpha_0_30_beta_0_30[i] == Approx(ssm(i,i,0)).epsilon(1e-6) ); 
  }
  //for ( size_t i = 0; i < ssm_alpha_50_104_beta_58.size(); ++i ){ 
    //std::cout << 50+i << "    " << ssm_alpha_50_104_beta_58[i] << "    " << ssm(50+i,58,0) << std::endl; 
    //REQUIRE( ssm_alpha_50_104_beta_58[i] == Approx(ssm(50+i,58,0)).epsilon(1e-6) ); 
  //}
  std::cout << std::setprecision(16) << ssm(58,58,0) << std::endl; 
  std::cout << std::setprecision(16) << ssm(59,58,0) << std::endl; 
