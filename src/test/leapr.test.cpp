...
TEST_CASE( "leapr" ){
  ...
  */
  ...
  std::vector<double> ssmDiagonal { 11.935614, 9.6753951, 7.3348118, 6.0777375, 4.7152145, 3.7635737, 3.1352778, 2.5435978, 1.9451342, 1.5299730, 0.9617595, 0.5859237, 0.3524469, 0.2124005, 0.1300019, 8.2531345e-2, 5.6886704e-2, 4.3458881e-2, 3.6822232e-2, 3.4067983e-2, 3.3632585e-2, 3.4628352e-2, 3.6546693e-2, 3.9131910e-2, 4.2191691e-2, 4.5634099e-2, 4.9388018e-2, 5.3368441e-2, 5.7527799e-2, 6.1792375e-2, 6.6065929e-2, 7.0233475e-2, 7.4218351e-2, 7.7872169e-2, 8.1100605e-2, 8.3812876e-2, 8.5914606e-2, 8.7365248e-2, 8.8101263e-2, 8.8115627e-2, 8.7348737e-2, 8.5804720e-2, 8.3492917e-2, 8.0470802e-2, 7.6789248e-2, 7.2560911e-2, 6.7879552e-2, 6.2878926e-2, 5.7644932e-2, 5.2325611e-2, 4.6996838e-2, 4.1750932e-2, 3.6686082e-2, 3.1863917e-2, 2.7336267e-2, 2.3145924e-2, 1.9324611e-2, 1.5889523e-2, 1.2853166e-2, 1.0214210e-2, 7.9612973e-3, 6.0777445e-3, 4.5355538e-3, 3.3038095e-3, 2.7361841e-3 };
   
  for ( size_t i = 0; i < ssmDiagonal.size(); ++i ){ 
    //std::cout << i << std::endl;
    //REQUIRE( ssmDiagonal[i] == Approx(ssm(i,i,0)).epsilon(1e-6) ); 
  }
  //checkSab( ssmCorrect, ssm );
