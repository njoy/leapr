...
*/
  ...
  GIVEN( "Liquid CH4 ENDF-B/VIII.0 input" ) {
    WHEN( "" ) {
      nphon = 100;
      mat = 33; za = 1001; isabt = 0; ilog = 0; smin = 1e-75;
      awr = 0.99917; spr = 20.478; npr = 4; iel = 0; ncold = 0; nsk = 0;
      nss = 1; b7 = 1.0; aws = 11.898; sps = 4.7392; mss = 1;
      lat = 0;
      ...
      temps = { 90.0, 100.0, 110.0 };
      std::vector<double> rho { 0., .004, .018, .034, .050, .068, .087, .109,
      ...
      std::vector<double> rho_dx_vec {0.0004, 0.0004, 0.0004},
                             twt_vec {0.015, 0.015, 0.015},
                               c_vec {200.0, 200.0, 200.0},
                           tbeta_vec {0.305, 0.305, 0.305},
                                oscE {0.162, 0.190, 0.361, 0.374},
                                oscW {0.308, 0.186, 0.042, 0.144},
                            kappaVec { };
      std::vector<std::vector<double>> rhoVec {rho, rho, rho},
                                       transInfo {twt_vec,c_vec,tbeta_vec},
                                       oscE_vec {oscE, oscE, oscE},
      ...
      auto my_MF7 = leapr(generalInfo, scatterControl, scatterInfo, temps, 
        alphas, betas, rhoVec, rho_dx_vec, transInfo, oscE_vec, oscW_vec, smin);
