...
TEST_CASE( "leapr" ){
  ...
  GIVEN( "quickTest" ) {
    ...
    lat   = 0;            
    alpha = {.01008,   .033,     0.050406, 0.403248, 0.504060, 0.554466, 
             0.670259, 1.873790, 2.055660, 2.473520, 5.671180, 7.472890, 
             8.980730, 20.52030, 27.02160, 32.46250, 46.85030, 50.0};
    beta  = {0.000000, 0.006375, 0.038250, 0.06575, 0.564547, 0.887145, 1.77429,
             2.016240, 2.992500, 3.422470, 6.62607, 8.258620, 18.72180, 25.0};
    temp  = { 296.0 };                                          
    delta = 0.00255;                                           
