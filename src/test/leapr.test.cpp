...
TEST_CASE( "leapr" ){
  ...
  GIVEN( "Beryllium Oxide (pg 39 of NEW THERMAL NEUTRON SCATTERING FILES FOR "
    ...
    for ( size_t i = 0; i < ssm_alpha_89_beta_90_116.size(); ++i ){ 
      REQUIRE( ssm_alpha_89_beta_90_116[i] == Approx(ssm(89,90+i,0)).epsilon(1e-6) ); 
    }
    for ( size_t i = 0; i < ssm_alpha_20_40_beta_116.size(); ++i ){ 
      REQUIRE( ssm_alpha_20_40_beta_116[i] == Approx(ssm(20+i,116,0)).epsilon(1e-6) ); 
    }
