...
TEST_CASE( "coldHydrogen" ){
  ...
  GIVEN( "Ortho hydrogen"){
    ...
    WHEN( "molecular translations are assumed to not be free" ){
      ...
      THEN( "output scattering law vectors are correct" ){
        coldHydrogen( tev, ncold, transWeight + continWeight, 
  ...
  ska = { 0.001, 0.002, 0.005, 0.008, 0.01, 0.02, 0.05, 0.08, 0.1, 0.2, 0.5, 
          0.8, 1.0, 2.0, 5.0, 8.0, 5.0, 2.0, 1.0, 0.8, 0.5, 0.2, 0.1, 0.08, 
          0.05, 0.02, 0.01, 0.008, 0.005, 0.002, 0.001 };
