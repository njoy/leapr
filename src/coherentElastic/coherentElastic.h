...
#include "coherentElastic_util/hexLatticeFactors.h"
#include "coherentElastic_util/bccLatticeFactors.h"
#include "coherentElastic_util/fccLatticeFactors.h"
#include "coherentElastic_util/end.h"

template <typename Range>
static inline auto coherentElastic( int iel, int npr, Range& b, double maxEnergy ){
  /* Compute Bragg energies and associated structure factors
   * for coherentElasticent elastic scattering from graphite, Be, or BeO.
   *
  ...
  // Effective bound coherent elastic scattering cross section (b)
