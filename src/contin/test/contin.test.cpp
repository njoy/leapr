  ...
  GIVEN( "simplified water model (test case #9)" ){
    ...
    WHEN( "  " ){
      ...
      THEN( "contin output matches expected value" ){
        ...
        std::cout << symSab(64,64,0) << "     " << correct_alpha_49_to_74_beta_64[14] << std::endl;
        std::cout << symSab(64,64,0) << "     " << correct_alpha_49_to_74_beta_64[15] << std::endl;
        std::cout << symSab(64,64,0) << "     " << correct_alpha_49_to_74_beta_64[16] << std::endl;
      } // THEN
    } // WHEN
  } // GIVEN
