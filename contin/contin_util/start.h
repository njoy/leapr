...
auto start( std::vector<double>& p, double& delta, const double& tev, const double& tbeta ){
    /* start is going to make delta unitless, changing it to what leapr.f90
     * called deltab
     */
